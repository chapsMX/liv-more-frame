...
export default function Demo(
  ...
  // Get user tokens
  const { data: userTokensData, refetch: refetchUserTokens } = useContractReads({
    contracts: [
      {
        ...contractConfig,
  ...
  const { data: attestationsData, refetch: refetchAttestations } = useContractReads({
  ...
  useEffect(() => {
    if (isMintSuccess) {
      ...
      setTimeout(async () => {
        try {
          // Refetch both user tokens and attestations
  ...
  }, [isMintSuccess, refetchUserTokens, refetchAttestations]);
