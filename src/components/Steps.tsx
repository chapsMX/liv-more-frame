              ...
              onClick={async () => {
                ...
                try {
                  ...
                  const shareText = myEntry
                    ? `I'm #${myEntry.rank} on @livmore's Weekly Leaderboard with ${formatSteps(myEntry.total_valid_steps)} valid steps 👟\n@livmore rewards your steps with $STEPS token every week 👟\n\nTop 5 walkers split 80% of the weekly prize pool — 16% each.\n\nConnect your device, attest your daily steps and join the challenge 👇`
                    : `Steps Leaderboard\n@livmore rewards your steps with $STEPS token every week 👟\n\nTop 5 walkers split 80% of the weekly prize pool — 16% each.\n\nConnect your wearable, attest your daily steps and join the challenge 👇`;
